...
plt.title("Top 20 most common words in user's review - Bug Report")
sns.barplot(x=y,y=x,)
...
"Issues - 900 out of 33K reviews contains the word 'stop work'"


df.to_excel('bug_report_key.xlsx', index=False)      
"Issues - 17477 is very buggy (over80% from the top10)"     
...
wordcloud.to_file("wordcloud_C1.png")